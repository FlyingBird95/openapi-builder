...
def post():
    ...
    try:
        data = RegisterUser.deserialize(request.data)
    except ValidationError as e:
        return jsonify(ErrorSchema.serialize({"message": e})), HTTPStatus.BAD_REQUEST
    ...
    user.save()
    return jsonify(UserSchema.serialize(user)), HTTPStatus.CREATED
